#!/usr/bin/env python3
"""Plot best speculative hit rate vs aging factor, one panel per algorithm."""
...
def make_legend(fig: plt.Figure) -> None:
    ...
    mode_handles = [
        Line2D([0], [0], color="#666666", linewidth=0.55, label="Speculative Best"),
...
def plot_by_algorithm(root: Path, output_dir: Path) -> tuple[Path, Path]:
    ...
    base = output_dir / f"{MODE}_best_by_algorithm"
